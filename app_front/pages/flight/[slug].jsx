...
const Flight = () => {
    ...
    const headerDivContact = css`
        ...
        align-items:center;
        justify-content:center;
        ${slug === "domflight" && "background-image:linear-gradient(to bottom right, rgba(0, 6, 61, 0.48) , rgba(0, 6, 61, 0.48)) ,url(/images/Flights/domflight.png);"} 
        ${slug === "forflight" && "background-image:linear-gradient(to bottom right, rgba(0, 6, 61, 0.48) , rgba(0, 6, 61, 0.48)) ,url(/images/Blog/blog.jpg);"} 
    ...
    return(
        ...
        <div css={mainDivContact}>
            <div css={headerDivContact}>
                {slug === "domflight" && <H1> پرواز داخلی</H1>} 
                {slug === "forflight" && <H1> پرواز خارجی</H1>} 
            </div> 
